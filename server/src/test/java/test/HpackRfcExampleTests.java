...
public class HpackRfcExampleTests {
    ...
    public void shouldEncode10Using5BitPrefix() {
        assertEncodingEquals(new byte[]{0b00001010}, 10, 5);
    }
    ...
    public void shouldEncode1337UsingA5BitPrefix() {
        assertEncodingEquals(new byte[]{0b00011111, (byte) 0b10011010, 0b00001010}, 1337, 5);
    }
    ...
    public void shouldEncode42StartingAtAnOctetBinary() {
        assertEncodingEquals(new byte[]{0b0010_1010}, 42, 8);
    }
    ...
    public void shouldEncodeHeaderList() {
        ...
        // C.3.1. First Request
        Map<String, String> firstHeaders = new HashMap<>();
        firstHeaders.put(":method", "GET");
        firstHeaders.put(":scheme", "http");
        firstHeaders.put(":path", "/");
        firstHeaders.put(":authority", "www.example.com");

        byte[] firstExpected = new byte[] {
                (byte) 0x82, (byte) 0x86, (byte) 0x84,0x41, 0x0f,0x77, 0x77,0x77,  0x2e,0x65, 0x78,0x61, 0x6d,0x70, 0x6c,0x65,
                0x2e,0x63, 0x6f,0x6d
        };

        Assert.assertArrayEquals(firstExpected, hpack.encodeHeaderList(firstHeaders));

        /**
         * C.3.2.  Second Request
         */
        Map<String, String> secondHeaders = new HashMap<>();
        ...
        byte[] secondExpected = new byte[] {
                (byte) 0x82, (byte) 0x86, (byte) 0x84, (byte) 0xbe, 0x58,0x08, 0x6e,0x6f, 0x2d,0x63, 0x61,0x63, 0x68,0x65
        };

        Assert.assertArrayEquals(secondExpected, hpack.encodeHeaderList(secondHeaders));

        /**
         * C.3.3.  Third Request
         */
        Map<String, String> thirdHeaders = new HashMap<>();
        ...
        byte[] thirdExpected = new byte[] {
                (byte) 0x82, (byte) 0x87, (byte) 0x85, (byte) 0xbf, 0x40,0x0a, 0x63,0x75,  0x73,0x74, 0x6f,0x6d, 0x2d,0x6b, 0x65,0x79,
                0x0c,0x63, 0x75,0x73, 0x74,0x6f, 0x6d,0x2d,  0x76,0x61, 0x6c,0x75, 0x65
        };

        Assert.assertArrayEquals(thirdExpected, hpack.encodeHeaderList(thirdHeaders));
    ...
    public void shouldEncodeHeaderListWithHuffmanEncoding() {
        ...
        byte[] firstExpected = new byte[] {
                (byte) 0x82, (byte) 0x86, (byte) 0x84,0x41 , (byte) 0x8c, (byte) 0xf1, (byte) 0xe3, (byte) 0xc2, (byte) 0xe5, (byte) 0xf2,0x3a,0x6b , (byte) 0xa0, (byte) 0xab, (byte) 0x90, (byte) 0xf4,
                (byte) 0xff
        };
        Assert.assertArrayEquals(firstExpected, hpack.encodeHeaderList(firstHeaders));
        ...
        byte[] secondExpected = new byte[] {
                (byte) 0x82, (byte) 0x86, (byte) 0x84, (byte) 0xbe,0x58, (byte) 0x86, (byte) 0xa8, (byte) 0xeb,0x10,0x64 , (byte) 0x9c, (byte) 0xbf
        };
        ...
        byte[] thirdExpected = new byte[] {
                (byte) 0x82, (byte) 0x87, (byte) 0x85, (byte) 0xbf,0x40, (byte) 0x88,0x25, (byte) 0xa8,0x49, (byte) 0xe9,0x5b, (byte) 0xa9,0x7d,0x7f , (byte) 0x89,0x25,
                (byte) 0xa8,0x49 , (byte) 0xe9,0x5b , (byte) 0xb8, (byte) 0xe8, (byte) 0xb4, (byte) 0xbf
        };
    ...
    public void shouldEncodeResponseHeaders() {
        ...
        byte[] firstExpected = convertToByteArray(new int[] {
        ...
        byte[] secondExpected = convertToByteArray(new int[] {
        ...
        byte[] thirdExpected = convertToByteArray(new int[] {
     ...
     */
    private static void assertEncodingEquals(byte[] expected, int n, int prefixBits) {
     ...
     *
     * eg. byte[] expected = convertToByteArray(new int[] { 0xff });
     *
     * @param intArray The integer array to be converted,
